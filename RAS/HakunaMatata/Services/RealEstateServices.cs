...
namespace HakunaMatata.Services
{
    ...
    public class RealEstateServices : IRealEstateServices
    {
        ...
        public List<VM_RealEstate> GetList()
        {
            ...
            foreach (var item in details)
            {
                var vm_rt = new VM_RealEstate()
                {
                    ...
                    UrlImage = item.RealEstate.Picture.FirstOrDefault()?.Url // Retrieve the URL field from Pictures
                };
        ...
        public List<VM_WishList> GetWishList()
        {
